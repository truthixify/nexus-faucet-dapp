...
const CONTRACT_ADDRESS = '0x463BfdC6Ef34468b1a284b180f6cda4cBacE5757'
                        ...
                        <div className="space-y-8">
                           ...
                           focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
                                ...
                                <div className="flex flex-col gap-8">
                                    <div className="flex items-center justify-center gap-4">
                                        <div className="text-black">
                                            <input
                                                className="w-20 px-4 py-3 border-2 border-black rounded-lg px-4 focus:outline-none text-center"
                                                type="text"
                                    ...
                                    <div className="flex items-center justify-center gap-4">
                                        <div className="text-black">
                                            <input
                                                ...
                                                type="text"
                                                onChange={(e) =>
                                                    setCoolDownTime(Number(e.target.value) || 0)
                                                }
                                                value={coolDownTime}
                                            />
                                        </div>
                                ...
                                <div className="w-full flex flex-col gap-8">
                                    <div className="text-black">
                                        <input
                                            className="w-3/5 px-4 py-3 border-2 border-black rounded-lg px-4 focus:outline-none text-center"
                                            type="text"
                                            value={userAddress}
                                            readOnly
                                        />
